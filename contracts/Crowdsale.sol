 ...
 * behavior.
 * This is derived from openzeppelin contracts rel 2.5.0
 * THis is installed own Crowdsale contract in this project since OpenZeppelin dont have the Crowdsale contract for implementation anymore.
 */
contract Crowdsale is Context, ReentrancyGuard {
    /// @notice This project, will adapt CrowdSale to sell the tokens
